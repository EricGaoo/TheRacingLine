...
public struct Turn3ContentView: View {
...
@State private var showWrong = false
    ...
    public var body: some View {
        ZStack {
            ...
            Image(uiImage: #imageLiteral(resourceName: "Turn2.track.png"))
                .resizable()
                .scaledToFit()
                .frame(width: 1050, height: 1050)
                .position(x: 395, y: 730) //300, 100
            if showLine1 {
                Image(uiImage: #imageLiteral(resourceName: "Turn2.LineInC.png"))
                    .resizable()
                    .scaledToFit()
                    .frame(width: 750, height: 750, alignment: .center)
                    .position(x: 395, y: 732)
                    .transition(.asymmetric(insertion: .opacity, removal: .scale))
            }
            if showLine2 {
                Image(uiImage: #imageLiteral(resourceName: "Turn2.LineRace.png"))
                .resizable()
                .scaledToFit()
                .frame(width: 825, height: 825, alignment: .center)
                .position(x: 400, y: 700)
                .transition(.asymmetric(insertion: .opacity, removal: .scale))
            }
            if showLine3 {
                Image(uiImage: #imageLiteral(resourceName: "Turn2.LineOut.png"))
                .resizable()
                .scaledToFit()
                .frame(width: 800, height: 800, alignment: .center)
                .position(x: 390, y: 652)
                .transition(.asymmetric(insertion: .opacity, removal: .scale))
            }
            if showAnswer {
                Image(uiImage: #imageLiteral(resourceName: "Turn2.LineRaceG.png"))
                .resizable()
                .scaledToFit()
                .frame(width: 825, height: 825, alignment: .center)
                .position(x: 400, y: 700)
