...
public struct Turn4ContentView: View {
...
@State private var showWrong = false
    ...
    public var body: some View {
        ZStack {
            ...
            Image(uiImage: #imageLiteral(resourceName: "Turn4.track.png"))
                .resizable()
                .scaledToFit()
                .frame(width: 1050, height: 1050)
                .position(x: 635, y: 580)
            if showLine1 {
                Image(uiImage: #imageLiteral(resourceName: "Turn4.LineOut.png"))
                    .resizable()
                    .scaledToFit()
                    .frame(width: 660, height: 660, alignment: .center)
                    .position(x: 535, y: 552)
                    .transition(.asymmetric(insertion: .opacity, removal: .scale))
            }
            if showLine2 {
                Image(uiImage: #imageLiteral(resourceName: "Turn4.LineIn.png"))
                .resizable()
                .scaledToFit()
                .frame(width: 600, height: 600, alignment: .center)
                .position(x: 575, y: 557)
                .transition(.asymmetric(insertion: .opacity, removal: .scale))
            }
            if showLine3 {
                Image(uiImage: #imageLiteral(resourceName: "Turn4.Race.png"))
                .resizable()
                .scaledToFit()
                .frame(width: 600, height: 600, alignment: .center)
                .position(x: 515, y: 562)
                .transition(.asymmetric(insertion: .opacity, removal: .scale))
            }
            if showAnswer {
                Image(uiImage: #imageLiteral(resourceName: "Turn4.RaceG.png"))
                .resizable()
                .scaledToFit()
                .frame(width: 600, height: 600, alignment: .center)
                .position(x: 515, y: 562)
